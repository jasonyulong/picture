...
if (!defined('TTF_DIR')) {
	...
	//DEFINE('TTF_DIR','/usr/X11R6/lib/X11/fonts/truetype/');	// del by Frode (2014.05.22)
	DEFINE('TTF_DIR','/home/wwwroot/Public/fonts/');	// add by Frode (2014.05.22)
    }
}
